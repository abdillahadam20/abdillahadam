<template>
  <nav class="nav">
    <div class="nav-container">
      ...
      >
        <ul
          class="flex gap-4 flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white"
        >
          <MoleculesNavbarLink
