<template>
  <section class="bg-white relative dark:bg-gray-900 bg-dots">
    ...
    >
      ...
      <div class="w-full">
        <NuxtImg
          src="/static/abdillah.png"
          class="w-full rounded-full brightness-75"
          alt="Adam Abdillah"
        />
      </div>
    </div>
...
const icons = [
  {
    ...
    href: "https://www.linkedin.com/in/adam-abdillah/",
  },
  {
...
const downloadCV = () => {
  ...
  setTimeout(() => {
    ...
    link.href = "/static/Curriculum-Vitae-Adam-Abdillah.pdf";
